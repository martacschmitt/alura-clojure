...
(pprint @(db.venda/altera-situcao! conn venda1 "preparando"))
(pprint @(db.venda/altera-situcao! conn venda2 "preparando"))
(pprint @(db.venda/altera-situcao! conn venda2 "a caminho"))
(pprint @(db.venda/altera-situcao! conn venda2 "entregue"))
...
(pprint (db.venda/historico-geral (d/db conn) #inst "2022-06-28T16:19:56.377-00:00"))

(pprint (db.venda/historico-geral (d/db conn) #inst "2022-06-28T16:29:56.377-00:00"))
