...
(defn testa-uso-de-pacientes []
  (let [guilherme {:id 15, :nome "Guilherme"}
        ...
        visitas {}
        visitas (adiciona-visita visitas 15 ["0/01/2019"])
        visitas (adiciona-visita visitas 20 ["01/02/2019", "01/01/2020"])
        visitas (adiciona-visita visitas 15 ["01/03/2019"])]
    (pprint pacientes)
    (pprint visitas)
    ; problemas porque estamos usando o mesmo símbolo 'paciente' com significado diferentes
...
; agora conseguimos o erro que diz que o valor passado no parâmetro não condiz com o schema Long
;(testa-uso-de-pacientes)
